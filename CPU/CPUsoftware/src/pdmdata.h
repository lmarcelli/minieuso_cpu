...
typedef struct
{
	...
	uint32_t hv_status;
	// raw data (2.5 us GTU)
	uint8_t raw_data [N_OF_FRAMES_RAW_POLY_V0][N_OF_ECASIC_PER_PDM][N_OF_PMT_PER_ECASIC][N_OF_PIXELS_PER_PMT];
	// integrated data (320 us GTU)
	uint16_t int16_data [N_OF_FRAMES_INT16_POLY_V0][N_OF_ECASIC_PER_PDM][N_OF_PMT_PER_ECASIC][N_OF_PIXELS_PER_PMT];
	// double integrated data (~40 ms GTU)
	uint32_t int32_data [N_OF_FRAMES_INT32_POLY_V0][N_OF_ECASIC_PER_PDM][N_OF_PMT_PER_ECASIC][N_OF_PIXELS_PER_PMT];
} DATA_TYPE_SCI_POLY_V3;

typedef struct
{
	ZynqBoardHeader zbh;
	DATA_TYPE_SCI_POLY_V3 payload;
} Z_DATA_TYPE_SCI_POLY_V3;
...
typedef struct
{
	...
	// double integrated data (~40 ms GTU)
} DATA_TYPE_SCI_POLY_V2;

typedef struct
{
	ZynqBoardHeader zbh;
	DATA_TYPE_SCI_POLY_V2 payload;
} Z_DATA_TYPE_SCI_POLY_V2;
