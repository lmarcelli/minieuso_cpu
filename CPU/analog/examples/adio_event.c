...
int main(int argument_count, char **arguments)
{
	...
	fprintf(stdout,
		"\n\tDM75xx Digital I/O Event Mode Interrupt Example Program\n\n");
	/*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	dm75xx_status = DM75xx_DIO_IRQ_Mode(board, DM75xx_DIO_MODE_EVENT);
	...
	for (i = 0; i < 10; i++) {
		...
		DM75xx_Exit_On_Error(board, dm75xx_status,
				     "DM75xx_DIO_Set_Port");
		sleep(1);
		fprintf(stdout, "Port 1 Output:0x%2x Interrupts %d \r", vals[i],
			interrupts);
		fflush(stdout);
	}
	fprintf(stdout, "\n");
